...
public class KnowledgeBaseChunk extends genaicommons.proxies.Chunk
{
	...
	/**
	 * @deprecated Use 'KnowledgeBaseChunk.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static genaicommons.proxies.KnowledgeBaseChunk initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return genaicommons.proxies.KnowledgeBaseChunk.load(context, mendixIdentifier);
	}
