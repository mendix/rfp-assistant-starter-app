...
public class ChunkCollection
{
	...
	/**
	 * @deprecated Use 'ChunkCollection.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static genaicommons.proxies.ChunkCollection initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return genaicommons.proxies.ChunkCollection.load(context, mendixIdentifier);
	}
